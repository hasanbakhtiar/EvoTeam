...
//     if (username === info.user.username && password === info.user.pass) {
//             for(let x in info.product){
//                 return info.product[x].title;
//     }
//     }else{
//        return 'login is wrong...'
//     }
// }
// console.log(account("info","info1"));


// console.log(info.product.length);
// const myArr = ['table','pen','book'];
// myArr.pop('new value');
// myArr.push('new value');
// myArr.shift();
// myArr.unshift('new data');
// console.log(myArr);

const randomvalue = Math.floor(Math.random() * 4);
console.log(info.product[randomvalue].title);
